...
const commercialCards: OfferCard[] = [
  {
    ...
    subtitle: (
      <span className="inline-flex items-baseline gap-2">
        <span className="text-slate-600">Базова стойност:</span>
        <span className="text-3xl font-extrabold text-slate-900">4000 евро</span>
      </span>
    ),
    items: [
      'Базовата стойност следва модела от reference discovery офертата.',
      'Модулът за custom създаване на чанта е голям и се оценява отделно след детайлизация.',
      'Приоритетната поръчка е добавена стойност на ниво клиентска поръчка.',
      'Възможност за поетапно надграждане според растежа на бранда.',
    ],
    goal: 'ясна и прозрачна ценова рамка още в discovery фазата',
  },
  {
    icon: <LayoutGrid className="h-6 w-6" />,
    ...
    color: 'from-slate-700 to-slate-900',
    items: [
      'Discovery анализ и детайлно структуриране на функционалностите.',
      'UX/UI дизайн в стил оферта + дизайн насоки за сайта.',
      'Разработка на основните модули и свързване на логиката между тях.',
      'Тестване, финални настройки и подготовка за работа.',
      'Въвеждане и базово обучение за работа с администрацията.',
    ],
    goal: 'пълна яснота какво стои зад инвестицията и какъв резултат се получава',
  },
  {
    icon: <Clock className="h-6 w-6" />,
    title: 'Време за реализация',
    color: 'from-blue-600 to-cyan-600',
    items: ['Ориентировъчно 3-4 месеца за базов пакет + core функционалности.', 'Custom модулът се планира като отделен етап според обхвата.'],
    goal: 'реалистичен график с контролируеми етапи и ясни очаквания',
  },
  {
    ...
    items: [
      <>
        <span className="font-semibold text-slate-900">50%</span> при старт
      </>,
      <>
        <span className="font-semibold text-slate-900">50%</span> при завършване
      </>,
      'Отделните допълнителни модули се остойностяват преди имплементация.',
    ],
    goal: 'предвидима финансова структура и по-лесно планиране на бюджета',
  },
  {
    icon: <Filter className="h-6 w-6" />,
    title: 'След старта и извън обхвата',
    color: 'from-slate-500 to-slate-700',
    items: [
      'След старта: възможност за поддръжка, оптимизации и надграждане.',
      'Извън обхвата: функционалности, които не са описани в discovery списъка.',
      'Извън обхвата: външни платени услуги, ако възникнат такива.',
    ],
    goal: 'по-малко недоразумения и ясни очаквания за двете страни',
  },
]
      ...
      <main className="mx-auto w-full max-w-5xl px-6 py-10 md:py-12">
        <section className="mb-12 rounded-3xl bg-gradient-to-br from-teal-600 to-blue-600 p-8 text-white shadow-xl md:p-12">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 font-manrope text-lg leading-relaxed text-cyan-50">
              Подредена в стил като reference discovery проекта: ясни функционалности, обхват, стойност и стъпки за
              реализация. Сайтът и администрацията остават отделни, но концепцията е свързана.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <LuxuryLink to={DEMO_SITE} variant="admin-outline" className="!normal-case">
                Демо сайт
              </LuxuryLink>
              <LuxuryLink to="/admin" variant="admin-outline" className="!normal-case">
                Демо администрация
              </LuxuryLink>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-4 font-manrope text-lg leading-relaxed text-slate-200">
                В офертата са включени всички ключови модули, които поиска: топ гледани/продавани продукти, категории,
